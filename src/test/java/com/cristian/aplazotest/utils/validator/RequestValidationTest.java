...
public class RequestValidationTest {
    ...
    public void requestValidationTest(){
       ...
       thrown = assertThrows(AplazoException.class, ()->{
        ...
        thrown = assertThrows(AplazoException.class, ()->{
            RequestValidation.validateRequest(RequestDto.builder().amount(1d).term(15).rate(0d).build());
        });
        assertEquals(thrown.getMessage(), AplazoConstants.INVALID_RATE);
    }
}
