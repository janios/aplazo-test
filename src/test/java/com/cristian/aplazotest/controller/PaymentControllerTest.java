...
public class PaymentControllerTest {
  ...
  public void calculateEndPointTest() throws Exception {
    RequestDto requestDto = RequestDto.builder().amount(10d).rate(.1).term(10).build();
  ...
  public void calculateEndPontBadResponseTest() throws Exception {
    ...
    ResponseEntity<AplazoErrorMessage> response =
        restTemplate.postForEntity(CALCULATE_URL, requestDto, AplazoErrorMessage.class);
  ...
  public void paymentEndPointTest() throws Exception {
    ...
    ResponseEntity<CreditDto[]> response =
        restTemplate.getForEntity(PAYMENTS_URL, CreditDto[].class);
